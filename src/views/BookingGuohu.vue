    ...
    <div v-transfer-dom>
      <popup v-model="showNotice" position="bottom">
        <div class="notice-list">
          ...
          <p>9座以下（含9座）车辆类型为小型客车（含新能源车）的国产合资及海关进口车辆可办理市内过户和迁出提档业务。</p>
          <p class="mt10">使用性质为非营运、营转非、出租转非、预约出租转非的小型客车可办理市内过户和迁出提档业务</p>
          <p class="color">PS：办理业务过程不能改变车辆的使用性质、 另：预约出租客运性质的车辆办理业务需有交委核发的保留或注销通知书。</p>
          <p class="mt10">车辆类型为轻型、微型货车（含新能源）的国产合资车辆可办理市内过户和迁出业务，进口轻型、微型货车（含新能源）办理市内过户业务。</p>
          <p class="color">PS：进口货车迁出业务暂未开通</p>
          ...
          <p class="mt10">预约本站迁出业务，请在上一宗车管业务（过户、变更、补证、解押，其他站点预约）办结后20天再预约。</p>
          <p class="color">PS：市内过户业务不受此影响</p>

          <h3 class="notice-title mt10">预约时间：</h3>
          <p>全天24小时都可预约次工作日的市内过户业务。</p>
